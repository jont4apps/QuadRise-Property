...
```mermaid
graph TD
    A[Investors<br/>Equity Partners] -->|Equity Contribution| B[SPV<br/>Company or Unit Trust]
    C[Developer/Manager<br/>You] -->|Sweat Equity /<br/>Management Rights| B
    D[Commercial Lender] -->|70% LVR Debt| B
    B -->|Owns| E[4 × NDIS Villas<br/>SDA Property]
    E -->|Rental Income<br/>$340K p.a.| B
    B -->|Distributions<br/>per Waterfall| A
    B -->|Promote/Fees| C
```
